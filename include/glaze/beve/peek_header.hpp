...
namespace glz
{
   ...
   [[nodiscard]] GLAZE_EXPORT inline expected<beve_header, error_ctx> beve_peek_header(const void* data, size_t size) noexcept
   {
   ...
   [[nodiscard]] GLAZE_EXPORT inline expected<beve_header, error_ctx> beve_peek_header_at(const void* data, size_t size,
